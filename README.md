# SETTUP AND CREATING AN API CLIENT-SERVER HL7-FHIR STU3 v3.1.0 IN WINDOWS Part1:
...
Hl7.Fhir.Model contains model classes that correspond to the FHIR Resources and data types, like Patient and HumanName.
